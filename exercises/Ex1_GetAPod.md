# Exercise 1: Get a POD and login to communitypod app

**Table of Contents**

- [Exercise 1: Get a POD and login to communitypod app](#exercise-1-get-a-pod-and-login-to-communitypod-app)
  - [Setup](#setup)
  - [Get a POD](#get-a-pod)
  - [Login and set master encryption key](#login-and-set-master-encryption-key)

This exercise will show you how to create a POD on the solid server host https://solidcommunity.au/ and how to use the communitypod app to create and save notes to your POD.

## Setup<a name="setup"></a>

**Option 1:** Open the communitypod app using the web app or download links for the binary for your OS:

- [communitypod web app](https://communitypod.solidcommunity.au/)

Using Flutter framework, we can build apps for multiple platforms with a single codebase.

Go to [Downloads](https://github.com/anusii/communitypod/tree/main/installers) to get the communitypod app binaries for your platform:

- communitypod.dmg (Mac)
- communitypod.exe (Windows)
- communitypod.apk (Android)
- communitypod.tar.gz (Linux)


**Option 2:** If you already have `flutter` installed and setup to build to `chrome` or desired platform (Linux, MacOS, Windows, Android, iOS), you may build and run the communitypod app locally on your machine.
...
The communitypod app stores your files in encrypted form. To do this you must create a password to use as the master key for encrypting your POD files.
The first time you login in to the communitypod app, you need to set the master key for encryption. Your files are only decrypted in the app. Each time you subsequently login, you will need to provide the master key after app login to see your files.

Open [communitypod app](https://communitypod.solidcommunity.au/) and click `Login`.
...
Click `Authorize` to login to your POD in the communitypod app.
...
![communitypod setup wizard](../assets/images/pod_wizard.png)

Enter a new password to use as your master encryption key for this POD.

Click the confirm checkbox and click `Submit`.

You are now setup and logged in the communitypod app.

Repeat login to the communitypod app will typically remember your pod webID in the Authorize window.
