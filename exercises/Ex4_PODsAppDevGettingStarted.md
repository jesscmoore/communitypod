...
- [Exercise 4: Getting started - PODs app development with Flutter](#exercise-4-getting-started---pods-app-development-with-flutter)
  ...
  - [Get communitypod code](#get-communitypod-code)
  - [Make changes to the communitypod app](#make-changes-to-the-communitypod-app)
    - [Tackle a communitypod issue](#tackle-a-communitypod-issue)
  - [More resources](#more-resources)

This exercise provides resources to install Flutter and get started developing PODs based apps with Flutter.

You will have the opportunity to build and run the communitypod app on your local machine, and add small features to the communitypod app.

You do not need to run a Solid server, as the communitypod app uses the Community Solid Server open source software running on the Solid Community AU server <https://pods.solidcommunity.au>
...
## Get communitypod code<a name="get_communitypod"></a>

Now lets get the communitypod project setup in your flutter development environment.

Go to [communitypod repo](https://github.com/anusii/communitypod). You can either Clone the repo by

```bash
git clone https://github.com/anusii/communitypod.git
```

or you can fork it to your own GitHub account.

Now open your VS Code IDE. Go to `File -> Open Folder` and select the local communitypod directory.

*You are now ready to make changes to the communitypod app with Flutter.*

## Make changes to the communitypod app<a name="edit_communitypod"></a>

There are a couple of options you can use to run the communitypod app.
...
Go to the `communitypod` directory and run the following command.
...
In the VS Code Explorer bar open the file `communitypod -> lib -> main.dart`. A play button will apear on the top right had coner of your window. Click that button and select either one of the options and the app will then run.

For the first time it will again ask for you to setup the preferred device for the app to run on.

**Editing communitypod app**

Open the communitypod repo in your favourite editor. You can use any editor you like.
...
### Tackle a communitypod issue<a name="communitypod_issue"></a>

Now you can have a go at contributing to an [issue in the communitypod repo](https://github.com/anusii/communitypod/issues).
